...
<body class="bg-primary bg-background">
    ...
    <div class="w-full text-white bg-secondary dark-mode:text-gray-200 dark-mode:bg-gray-800 border-b-2">
        <div x-data="{ open: false }" class="flex flex-col max-w-screen-xl px-4 mx-auto lg:items-center lg:justify-between lg:flex-row md:px-6 lg:px-8">
            ...
            <nav :class="{'flex': open, 'hidden': !open}" class="flex-col flex-grow pb-4 md:pb-0 hidden lg:flex lg:justify-end lg:flex-row">
                <a class="px-4 py-2 mt-2 text-sm text-white rounded-xl border-2 border-solid border-transparent hover:border-current cursor-pointer select-none" href="/">AVALEHT</a>
                <a class="px-4 py-2 mt-2 text-sm text-yellow-400" href="/kontakt">KONTAKT</a>
    ...
    <div class="container md:px-16 mx-auto mb-12 mt-8 ">
            ...
            <div class="mt-8 sm:mt-0 sm:w-full sm:p-8 text-white md:flex-row">
                <div class="flex flex-col sm:flex-row justify-between py-8 sm:py-0 flex-wrap">
                    <div class="mb-0">
                        ...
                        <form action="https://formsubmit.co/sadam@muratsi.ee" method="POST" class="flex flex-col text-black">
                            <div>
                                <input type="text" name="name" placeholder="Nimi" required class="border-black border-b-4 w-max">
                                <input type="email" name="email" placeholder="Email" required class="border-black border-b-4 w-max">
                            </div>
                            <input type="text" name="_subject" placeholder="Teema" required class="my-4 border-black border-b-4">
                    ...
                    <div>
                        <div>
                            <div class="flex"><svg class="place-self-center mr-2" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M11 14.6663C13.0251 14.6663 14.6667 13.0247 14.6667 10.9997C14.6667 8.97463 13.0251 7.33301 11 7.33301C8.97497 7.33301 7.33334 8.97463 7.33334 10.9997C7.33334 13.0247 8.97497 14.6663 11 14.6663Z" fill="white" />
                                    <path d="M11.9167 3.73008V1.8335H10.0833V3.73008C8.47028 3.93604 6.97123 4.67165 5.82137 5.82152C4.6715 6.97138 3.93588 8.47044 3.72993 10.0835H1.83334V11.9168H3.72993C3.93558 13.53 4.6711 15.0292 5.82102 16.1791C6.97094 17.3291 8.47016 18.0646 10.0833 18.2702V20.1668H11.9167V18.2702C13.5299 18.0647 15.0292 17.3293 16.1792 16.1793C17.3291 15.0294 18.0646 13.5301 18.2701 11.9168H20.1667V10.0835H18.2701C18.0644 8.47032 17.3289 6.9711 16.179 5.82118C15.0291 4.67125 13.5299 3.93574 11.9167 3.73008ZM11 16.5002C7.96676 16.5002 5.50001 14.0334 5.50001 11.0002C5.50001 7.96691 7.96676 5.50016 11 5.50016C14.0333 5.50016 16.5 7.96691 16.5 11.0002C16.5 14.0334 14.0333 16.5002 11 16.5002Z" fill="white" /></svg>
                                58°13'49"N 22°34'34"E</div>
                            <a href="#""><small>Vaata navigatsioonikaarti</small></a>
                            <div class=" flex mt-4">
                                <div><svg class="place-self-center mr-2" width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="flex mt-4"><svg class="place-self-center mr-2" width="20" height="23" viewBox="0 0 20 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="https://www.facebook.com/muratsisadam/">www.facebook.com/muratsisadam</a></div>
                    </div>
                    <div class="mt-8">
